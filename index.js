...
app.post("/search", async (req, res) => {
  ...
  dblib.findProducts(req.body)
      .then(result => {
          console.log("dblib.findProducts result is: ", result);
          res.render("search", {
              type: "post",
              totRecs: totRecs.totRecords,
              result: result,
...
app.post("/searchajax", upload.array(), async (req, res) => {
  console.log("searchajax prior dblib call.  req.body is: ", req.body);
  dblib.findProducts(req.body)
      .then(result => {
        console.log("searchajax after dblib call.  result is: ", result);
        res.send(result)
      })
